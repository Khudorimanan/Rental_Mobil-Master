...
<div class="row">
    <div class="col-sm-4">
        ...
        <div class="card">
                ...
                <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Bonus sewa dapat E-toll 50k</li>
                <li class="list-group-item bg-dark text-white">
                    <i class="fa fa-money"></i> Rp. <?php echo number_format($isi['harga']);?>/ hari
                </li>
                <li class="list-group-item bg-dark text-white">
                    <i class="fa fa-money"></i> Denda seharga sewa <?php echo number_format($isi['harga']);?>/ hari
                </li>
                </ul>
            </div>
    </div>
